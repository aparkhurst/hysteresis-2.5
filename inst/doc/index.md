...
## function 'plot': Error: object 'nlssummodel' not found
```
...
## 1           b.x       A      0.572762  9.085e-04  0.037383  0.50268
## 2           b.y       A      0.792172 -9.613e-04  0.041965  0.70902
## 4            cx       A     -0.019481 -1.217e-03  0.027943 -0.07704
## 5            cy       A     -0.019910  2.392e-04  0.023056 -0.06512
## 6     retention       A      0.381257 -5.015e-03  0.064473  0.24643
## 7      coercion       A      0.249115 -2.755e-03  0.044523  0.15839
## 8          area       A      0.685863 -7.785e-03  0.125072  0.43110
## 9           lag       A      1.713483 -1.799e-02  0.304145  1.10773
## 11 hysteresis.x       A      0.435052 -5.606e-03  0.071827  0.28705
## 12 hysteresis.y       A      0.477585 -2.058e-03  0.098463  0.29535
## 13         ampx       A      0.572762  9.085e-04  0.037383  0.50268
## 14         ampy       A      0.876353 -2.415e-04  0.032669  0.81425
## 15     rote.deg       A     57.923639 -3.307e-02  2.149315 53.76225
## 17   semi.major       A      1.025118  7.487e-04  0.033943  0.95973
## 18   semi.minor       A      0.212947 -2.551e-03  0.038247  0.13475
## 19      focus.x       A      0.533191  5.051e-04  0.038817  0.46105
## 20      focus.y       A      0.851025 -5.513e-04  0.034453  0.78421
## 21 eccentricity       A      0.979014 -2.708e-04  0.008001  0.96096
## 22          b.x       B      0.550449 -1.790e-04  0.027837  0.49460
## 23          b.y       B      0.847377  4.760e-04  0.050596  0.74781
## 25           cx       B      0.017596  6.882e-04  0.020078 -0.01876
## 26           cy       B     -0.007568  6.497e-06  0.022994 -0.05284
## 27    retention       B      0.817603 -4.049e-04  0.052968  0.71218
## 28     coercion       B      0.382877 -1.007e-03  0.028689  0.32542
## 29         area       B      1.414088 -1.378e-03  0.113426  1.19087
## 30          lag       B      2.931869 -2.185e-03  0.214372  2.53268
## 32 hysteresis.x       B      0.695474 -1.503e-03  0.040348  0.61658
## 33 hysteresis.y       B      0.959003  4.841e-03  0.109998  0.77525
## 34         ampx       B      0.550449 -1.790e-04  0.027837  0.49460
## 35         ampy       B      1.175653  1.916e-03  0.031480  1.11579
## 36     rote.deg       B     69.584631  5.294e-02  1.520630 66.52855
## 38   semi.major       B      1.246901  2.030e-03  0.030847  1.19086
## 39   semi.minor       B      0.361003 -9.516e-04  0.027254  0.30604
## 40      focus.x       B      0.416660 -5.357e-04  0.031081  0.35306
## 41      focus.y       B      1.119252  1.922e-03  0.033698  1.05385
## 42 eccentricity       B      0.957519  2.432e-05  0.006904  0.94278
## 43          b.x       C      0.997713  1.255e-03  0.031008  0.93899
## 44          b.y       C      0.817574  4.851e-04  0.033423  0.75630
## 46           cx       C     -0.004055 -7.469e-05  0.022654 -0.05059
## 47           cy       C     -0.015523 -3.814e-04  0.022810 -0.06001
## 48    retention       C      0.415076 -6.598e-04  0.041270  0.33527
## 49     coercion       C      0.452285 -8.450e-04  0.042936  0.36862
## 50         area       C      1.301190 -6.073e-04  0.134318  1.04553
## 51          lag       C      1.794780 -3.709e-03  0.176758  1.43998
## 53 hysteresis.x       C      0.453256 -1.349e-03  0.041236  0.36857
## 54 hysteresis.y       C      0.506435  1.497e-04  0.058417  0.39465
## 55         ampx       C      0.997713  1.255e-03  0.031008  0.93899
## 56         ampy       C      0.915923  1.117e-03  0.031890  0.85404
## 57     rote.deg       C     42.258326 -1.306e-03  1.479272 39.42161
## 59   semi.major       C      1.317384  1.867e-03  0.031498  1.26045
## 60   semi.minor       C      0.314401 -5.950e-04  0.031410  0.25266
## 61      focus.x       C      0.947480  9.200e-04  0.033337  0.88405
## 62      focus.y       C      0.860888  7.894e-04  0.033054  0.79629
## 63 eccentricity       C      0.971463 -1.649e-04  0.006014  0.95863
##    B.q0.975
## 1   0.64718
## 2   0.86928
## 4   0.03504
...
```
##                n                m              b.x              b.y 
##         5.000000         3.000000         0.604555         0.795187 
##      phase.angle               cx               cy        retention 
##         0.254264         0.006395        -0.001506         0.195793 
##         coercion             area              lag beta.split.angle 
##         0.321066         0.278897         0.922157         0.000000 
...
## Bootstrapped Estimates:
##                  Boot.Estimate       Bias Std.Error  B.q0.025 B.q0.975
## b.x                   0.604398  1.564e-04  0.006193  0.592275 0.616516
## b.y                   0.795275 -8.801e-05  0.005836  0.784300 0.806659
## phase.angle           0.508039 -2.538e-01  0.010112  0.233764 0.274364
## cx                    0.006392  3.017e-06  0.004138 -0.001672 0.014244
## cy                   -0.001567  6.071e-05  0.002744 -0.006558 0.003801
## retention             0.195414  3.794e-04  0.005592  0.185324 0.206722
## coercion              0.320852  2.133e-04  0.004058  0.313118 0.328788
## area                  0.278284  6.134e-04  0.008488  0.263059 0.295536
## lag                   0.920316  1.841e-03  0.026944  0.871143 0.974246
## beta.split.angle      0.000000  0.000e+00  0.000000  0.000000 0.000000
## hysteresis.x          0.530863  2.149e-04  0.003860  0.523646 0.538404
## hysteresis.y          0.245698  5.243e-04  0.007483  0.232087 0.260726
```
